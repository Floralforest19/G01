...
?>
   ...
   <input name="name" type="text" class="input__cat" required placeholder="Produktnamn">
   <div id="nameFeedback" style="color:#eb4b88"></div>
  </div> 
   
  <div> <label for="description"> Beskrivning:</label>
     <textarea name="description" type="text" cols="30" rows="5" class="input__cat" required placeholder="Beskrivning"> 
  </textarea>
  ...
  <div> <label for="quantity"> Antal:</label>
      <input name="quantity" type="number" class="input__cat" required placeholder="Antal">
      <div id="quantityFeedback" style="color:#eb4b88"></div>
  </div> 
   
    <div> <label for="price"> Pris:</label>
      <input name="price" type="number" class="input__cat" required placeholder="Pris">
...
function validateAll() {
    ...
    let priceValidated = validateNumberInput('createProdForm', 'price', 'priceFeedback');
